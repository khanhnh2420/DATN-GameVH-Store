...
import com.gamevh.reponsitory.RoleRepository;
...
public class AccountMapper {
    ...
    public Account mapRegisterAccountToAccount(RegisterAccountDTO registerAccountDTO){
    ...
    public RegisterAccountDTO parseRegisterAccountDTOFromJSON(String reisterAccountJSONString){
    ...
    public UpdateAccountDTO parseUpdateAccountDTOFromJSON(String updateAccountJSON){
